...
O critério referente ao alcance da linha aos limites do volume é direto garante que o \textit{streamline} esteja dentro do domínio descrito pelo DWI. 

O critério da baixa anisotropia vem da inferência, que, se a anisotropia é baixa, implica que \textit{streamline} saiu da substância branca do cérebro.
...
Em trabalhos na área, é muito comum a discretização de uma malha esférica via pontos obtidos através da subdivisão de um icosaedro, devido a sua uniformidade de amostras. Em seu algoritmo de tractografia proposto, \citeonline{descoteaux2007} utiliza uma malha esférica relativa a uma subdivisão de $16^a$ ordem de um icosaedro, de 2562 pontos. Já \citeonline{yeh2010} discretiza !!Falar do icosaedro desses caras.
