...
%A quantidade de amostras $N$ de ODF que customizam os glifos costumam estar na casa das centenas \cite{TuchQBall2004, yeh2010}, o que gera uma grande quantidade de dados enviados à GPU nas requisições de desenho.
...
Primeiro, vamos definir o conjunto de vetores $\Upsilon$ como uma função de $\Pi$ como mostrado na equação \ref{eq::u_vector_set}. A geometria do glifo é deformada escalonando cada ponto $P_k$ na malha para o valor ODF $\psi(\mathbf{u}_k)$. A matriz de translação coloca a malha esférica deformada para ser centralizada em um ponto $C(x, y, z)$.
