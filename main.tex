...
por um fator de normalização. \textcolor{red}{Uma boa aproximação da versão discreta de SDFs à versão contínua requer uma amostragem de direções 3D uniformemente espaçadas em torno de uma amostra. Discutiremos, adicionalmente, uma técnica para obter tal amostragem.}
