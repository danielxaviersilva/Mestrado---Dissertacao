...
Na renderização tridimensional, há uma funcionalidade para detecção de \textit{voxels}, em que cada um possui uma matriz de translação associada. A detecção é baseada em \textit{raycasting} computado sobre o volume na GPU, foi proposto e implementado no VMTK-Neuro por \citeonline{raphael_dissertacao}.
