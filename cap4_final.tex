...
Afim de facilitar a análise visual, as fatias selecionadas para o experimento das diversas configurações de fibras ocorrem de forma que as fibras a serem analisadas estejam contidas no plano coronal selecionado ou sejam normais ao plano.
...
%\captionsetup[subfloat]{farskip=0pt,nearskip=0pt}
    ...
    \hfill
    \subfloat[Superquádricos.] {\includegraphics[width=.47\linewidth, angle=0]{figs/Visual/103818/configuracoes/fanning/superquadricos}
